...
import static sun.security.tools.keytool.Main2.Command.*;
import static sun.security.tools.keytool.Main2.Option.*;
...
public final class Main2 {
    ...
    private Set<Pair2<String, String>> providers = null;
    ...
    private static final java.util.ResourceBundle rb =
        java.util.ResourceBundle.getBundle(
            "sun.security.tools.keytool.Resources2");
    ...
    void parseArgs(String[] args) {
        ...
        for (i=0; (i < args.length) && args[i].startsWith("-"); i++) {
             ...
             */
                ...
                if (providers == null) {
                    providers = new HashSet<Pair2<String, String>> (3);
                }
                ...
                providers.add(
                        Pair2.of(providerClass, providerArg));
            }
    ...
    void doCommands(PrintStream out) throws Exception {
        ...
        if (providers != null) {
            ...
            for (Pair2<String, String> provider: providers) {
        ...
        throws Exception
    {
        ...
        Pair2<Key,char[]> objs = recoverKey(alias, storePass, keyPass);
        ...
        throws Exception
    {
        ...
        Pair2<Entry,char[]> objs = recoverEntry(keyStore, orig, storePass, keyPass);
    ...
    private int doImportKeyStoreSingle(KeyStore srckeystore, String alias)
        ...
        Pair2<Entry,char[]> objs = recoverEntry(srckeystore, alias, srcstorePass, srckeyPass);
        Entry entry = objs.fst;
     ...
     * recover it.
     */
    private Pair2<Key,char[]> recoverKey(String alias, char[] storePass,
                                       char[] keyPass)
        throws Exception
    {
        Key key = null;
     ...
     */
    private Pair2<Entry,char[]> recoverEntry(KeyStore ks,
                            String alias,
                            char[] pstore,
...
class Pair2<A, B> {
    ...
    public boolean equals(Object other) {
        return
            other instanceof Pair2 &&
            Objects.equals(fst, ((Pair2)other).fst) &&
            Objects.equals(snd, ((Pair2)other).snd);
    }
    ...
    public static <A,B> Pair2<A,B> of(A a, B b) {
